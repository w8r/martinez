(function(A){"object"===typeof exports&&"undefined"!==typeof module?module.exports=A():"function"===typeof define&&define.U?define([],A):("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this).martinez=A()})(function(){return function g(c,k,f){function a(b,l){if(!k[b]){if(!c[b]){var q="function"==typeof require&&require;if(!l&&q)return q(b,!0);if(d)return d(b,!0);q=Error("Cannot find module '"+b+"'");throw q.code="MODULE_NOT_FOUND",q;}q=k[b]={exports:{}};
...
9:[function(g,c){c.exports={G:0,O:1,H:2,F:3}},{}],10:[function(g,c){c.exports=function(c,f){return c[0]===f[0]&&c[1]===f[1]}},{}],11:[function(g,c){function k(a,b,d,f){var y,c;if("number"===typeof a[0][0])for(y=0,c=a.length-1;y<c;y++){var h=a[y],e=a[y+1],g=b,l=d,m=f;if(!w(h,e)){var q=new r(h,!1,void 0,g),e=new r(e,!1,q,g);q.b=e;0<n(q,e)?e.left=!0:q.left=!0;m[0]=B(m[0],h[0]);m[1]=B(m[1],h[1]);m[2]=C(m[2],h[0]);m[3]=C(m[3],h[1]);l.push(q);l.push(e)}}else for(y=0,c=a.length;y<c;y++)k(a[y],b,d,f)}function f(a,
...
n(a[b],a[b+1])&&(e=a,h=b+1,g=e[b],e[b]=e[h],e[h]=g,e=!1);b=0;for(d=a.length;b<d;b++)a[b].u=b,a[b].left||(e=a[b].u,a[b].u=a[b].b.u,a[b].b.u=e);e=Array(a.length);h=[];g=[];c=[];var k={};b=0;for(d=a.length;b<d;b++)if(!e[b]){var r=[];h.push(r);var p=h.length-1;g.push(0);c.push(-1);if(a[b].v){var m=a[b].v.B;a[b].v.A?k[m]&&(q(h[c[m]],p),c[p]=c[m],g[p]=g[m],k[p]=!0):(q(h[m],p),c[p]=m,g[p]=g[m]+1,k[p]=!0)}m=b;for(r.push(a[b].a);m>=b;){e[m]=!0;a[m].left?(a[m].A=!1,a[m].B=p):(a[m].b.A=!0,a[m].b.B=p);m=a[m].u;
e[m]=!0;r.push(a[m].a);a:{for(var t=a,u=e,z=m+1,v=t.length;z<v&&w(t[z].a,t[m].a);)if(u[z])z+=1;else{m=z;break a}for(z=m-1;u[z];)--z;m=z}}m=-1===m?b:m;e[m]=e[a[m].u]=!0;a[m].b.A=!0;a[m].b.B=p;g[p]&1&&r.reverse()}return h}var x=[],v=g("./edge_type"),t=g("tinyqueue"),p=g("bintrees").P,r=g("./sweep_event"),n=g("./compare_events"),u=g("./compare_segments"),D=g("./segment_intersection"),w=g("./equals"),C=Math.max,B=Math.min;c.exports=e;c.exports.union=function(a,b){return e(a,b,1)};c.exports.diff=function(a,
b){return e(a,b,2)};c.exports.$=function(a,b){return e(a,b,3)};c.exports.intersection=function(a,b){return e(a,b,0)};c.exports.operations={INTERSECTION:0,DIFFERENCE:2,UNION:1,XOR:3};c.exports.X=f;c.exports.V=a;c.exports.Z=l;c.exports.W=h;c.exports.Y=b},{"./compare_events":7,"./compare_segments":8,"./edge_type":9,"./equals":10,"./segment_intersection":12,"./sweep_event":14,bintrees:2,tinyqueue:6}],12:[function(g,c){function k(a,d){return a[0]*d[1]-a[1]*d[0]}function f(a,d){return a[0]*d[0]+a[1]*d[1]}
c.exports=function(a,d,b,c,g){function q(a,b,d){return[a[0]+b*d[0],a[1]+b*d[1]]}d=[d[0]-a[0],d[1]-a[1]];c=[c[0]-b[0],c[1]-b[1]];b=[b[0]-a[0],b[1]-a[1]];var e=k(d,c),x=f(d,d);if(e*e>1E-9*x*f(c,c)){c=k(b,c)/e;if(0>c||1<c)return null;b=k(b,d)/e;return 0>b||1<b?null:g?null:[q(a,c,d)]}var v=f(b,b),e=k(b,d);if(e*e>1E-9*x*v)return null;b=f(d,b)/x;e=b+f(d,c)/x;c=Math.min(b,e);b=Math.max(b,e);return 1>=c&&0<=b?1===c?g?null:[q(a,0<c?c:0,d)]:0===b?g?null:[q(a,1>b?b:1,d)]:g&&0===c&&1===b?null:[q(a,0<c?c:0,d),
q(a,1>b?b:1,d)]:null}},{}],13:[function(g,c){c.exports=function(c,f,a){return(c[0]-a[0])*(f[1]-a[1])-(f[0]-a[0])*(c[1]-a[1])}},{}],14:[function(g,c){function k(d,b,c,f,g){this.left=b;this.a=d;this.b=c;this.i=f;this.type=g||a.G;this.o=this.s=!1;this.v=null;this.A=this.C=!1}var f=g("./signed_area"),a=g("./edge_type");k.prototype={w:function(a){return this.left?0<f(this.a,this.b.a,a):0<f(this.b.a,this.a,a)},S:function(a){return!this.w(a)},N:function(){return this.a[0]===this.b.a[0]}};c.exports=k},{"./edge_type":9,
"./signed_area":13}]},{},[1])(1)});
