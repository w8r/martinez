...
b.b.a)))return 0;if(2===f&&a.i===b.i)throw Error("Edges of the same polygon overlap");if(1===f)return w(a.a,c[0])||w(a.b.a,c[0])||h(a,c[0],d),w(b.a,c[0])||w(b.b.a,c[0])||h(b,c[0],d),1;var c=[],e=f=!1;w(a.a,b.a)?f=!0:1===n(a,b)?c.push(b,a):c.push(a,b);w(a.b.a,b.b.a)?e=!0:1===n(a.b,b.b)?c.push(b.b,a.b):c.push(a.b,b.b);if(f&&e||f)return a.type=v.O,b.type=a.s===b.s?v.H:v.F,f&&!e&&h(c[2].b,c[1].a,d),2;if(e)return h(c[0],c[1].a,d),3;if(c[0]!==c[3].b)return h(c[0],c[1].a,d),h(c[1],c[2].a,d),3;h(c[0],c[1].a,
d);h(c[3].b,c[2].a,d);return 3}function h(a,b,d){var c=new r(b,!1,a,a.i);b=new r(b,!0,a.b,a.i);0<n(b,a.b)&&(a.b.left=!0,b.left=!1);a.b.b=b;a.b=c;d.push(b);d.push(c);return d}function l(d,c,f,h,e,k){var g;f=new p(u);c=[];for(var n=A(h[2],e[2]);d.length;){var l=d.pop();c.push(l);if(0===k&&l.a[0]>n||2===k&&l.a[0]>h[2])break;l.left?(f.M(l),g=f.m(l),e=f.m(l),l.iterator=f.m(l),e.data()!==f.min()?e.D():(e=f.m(f.max()),e.next()),g.next(),a(l,e.data(),0,k),g.data()&&2===b(l,g.data(),d)&&(a(l,e.data(),0,k),
a(l,g.data(),0,k)),e.data()&&2===b(e.data(),l,d)&&(g=f.m(e.data()),g.data()!==f.min()?g.D():(g=f.m(f.max()),g.next()),a(e.data(),g.data(),0,k),a(l,e.data(),0,k))):(l=l.b,g=f.m(l),(e=f.m(l))&&g&&(e.data()!==f.min()?e.D():(e=f.m(f.max()),e.next()),g.next(),f.remove(l),g.data()&&e.data()&&b(e.data(),g.data(),d)))}return c}function q(a,b){"[object Array]"===Object.prototype.toString.call(a[0][0])||(a=[a]);a[b]=[]}function e(a,b,d){var c,e=null;if(0===a.length*b.length)if(0===d)e=x;else if(2===d)e=a;else if(1===
d||3===d)e=0===a.length?b:a;if(c=e)return c===x?null:c;var e=[Infinity,Infinity,-Infinity,-Infinity],h=[Infinity,Infinity,-Infinity,-Infinity],g=f(a,b,e,h);c=null;if(e[0]>h[2]||h[0]>e[2]||e[1]>h[3]||h[1]>e[3])if(0===d)c=x;else if(2===d)c=a;else if(1===d||3===d)c=a.concat(b);if(c)return c===x?null:c;e=l(g,0,0,e,h,d);a=[];b=0;for(d=e.length;b<d;b++)if(h=e[b],h.left&&h.C||!h.left&&h.b.b.C)a.push(h),a.push(h.b);for(e=!1;!e;)for(e=!0,b=0,d=a.length;b<d;b++)b+1<d&&1===n(a[b],a[b+1])&&(e=a,h=b+1,g=e[b],
e[b]=e[h],e[h]=g,e=!1);b=0;for(d=a.length;b<d;b++)a[b].u=b,a[b].left||(e=a[b].u,a[b].u=a[b].b.u,a[b].b.u=e);e=Array(a.length);h=[];g=[];c=[];var k={};b=0;for(d=a.length;b<d;b++)if(!e[b]){var r=[];h.push(r);var p=h.length-1;g.push(0);c.push(-1);if(a[b].v){var m=a[b].v.B;a[b].v.A?k[m]&&(q(h[c[m]],p),c[p]=c[m],g[p]=g[m],k[p]=!0):(q(h[m],p),c[p]=m,g[p]=g[m]+1,k[p]=!0)}var m=b,t=a[b].a;r.push(t);try{for(;!w(a[m].b.a,t);){e[m]=!0;a[m].left?(a[m].A=!1,a[m].B=p):(a[m].b.A=!0,a[m].b.B=p);m=a[m].u;e[m]=!0;
r.push(a[m].a);a:{for(var u=m,v=a,A=e,z=u+1;z<v.length&&w(v[z].a,v[u].a);)if(A[z])z+=1;else{m=z;break a}for(z=u-1;A[z];)--z;m=z}}e[m]=e[a[m].u]=!0;a[m].b.A=!0;a[m].b.B=p}catch(B){console.log(m||0,a,a.length,B)}g[p]&1&&r.reverse()}return h}var x=[],v=g("./edge_type"),t=g("tinyqueue"),p=g("bintrees").P,r=g("./sweep_event"),n=g("./compare_events"),u=g("./compare_segments"),D=g("./segment_intersection"),w=g("./equals"),B=Math.max,A=Math.min;c.exports=e;c.exports.union=function(a,b){return e(a,b,1)};c.exports.diff=
function(a,b){return e(a,b,2)};c.exports.$=function(a,b){return e(a,b,3)};c.exports.intersection=function(a,b){return e(a,b,0)};c.exports.operations={INTERSECTION:0,DIFFERENCE:2,UNION:1,XOR:3};c.exports.X=f;c.exports.V=a;c.exports.Z=l;c.exports.W=h;c.exports.Y=b},{"./compare_events":7,"./compare_segments":8,"./edge_type":9,"./equals":10,"./segment_intersection":12,"./sweep_event":14,bintrees:2,tinyqueue:6}],12:[function(g,c){function k(a,d){return a[0]*d[1]-a[1]*d[0]}function f(a,d){return a[0]*d[0]+
a[1]*d[1]}c.exports=function(a,d,b,c,g){function q(a,b,d){return[a[0]+b*d[0],a[1]+b*d[1]]}d=[d[0]-a[0],d[1]-a[1]];c=[c[0]-b[0],c[1]-b[1]];b=[b[0]-a[0],b[1]-a[1]];var e=k(d,c),x=f(d,d);if(e*e>1E-9*x*f(c,c)){c=k(b,c)/e;if(0>c||1<c)return null;b=k(b,d)/e;return 0>b||1<b?null:g?null:[q(a,c,d)]}var v=f(b,b),e=k(b,d);if(e*e>1E-9*x*v)return null;b=f(d,b)/x;e=b+f(d,c)/x;c=Math.min(b,e);b=Math.max(b,e);return 1>=c&&0<=b?1===c?g?null:[q(a,0<c?c:0,d)]:0===b?g?null:[q(a,1>b?b:1,d)]:g&&0===c&&1===b?null:[q(a,
0<c?c:0,d),q(a,1>b?b:1,d)]:null}},{}],13:[function(g,c){c.exports=function(c,f,a){return(c[0]-a[0])*(f[1]-a[1])-(f[0]-a[0])*(c[1]-a[1])}},{}],14:[function(g,c){function k(d,b,c,f,g){this.left=b;this.a=d;this.b=c;this.i=f;this.type=g||a.G;this.o=this.s=!1;this.v=null;this.A=this.C=!1}var f=g("./signed_area"),a=g("./edge_type");k.prototype={w:function(a){return this.left?0<f(this.a,this.b.a,a):0<f(this.b.a,this.a,a)},S:function(a){return!this.w(a)},N:function(){return this.a[0]===this.b.a[0]}};c.exports=
k},{"./edge_type":9,"./signed_area":13}]},{},[1])(1)});
