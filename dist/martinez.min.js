...
a.u===b.u?w.H:w.F,e&&!f&&h(c[2].b,c[1].a,d),2;if(f)return h(c[0],c[1].a,d),3;if(c[0]!==c[3].b)return h(c[0],c[1].a,d),h(c[1],c[2].a,d),3;h(c[0],c[1].a,d);h(c[3].b,c[2].a,d);return 3}function h(a,b,d){var c=new q(b,!1,a,a.h);b=new q(b,!0,a.b,a.h);0<m(b,a.b)&&(a.b.left=!0,b.left=!1);a.b.b=b;a.b=c;d.push(b);d.push(c);return d}function r(d,c,e,h,f,k){var g;e=new l(v);c=[];for(var m=A(h[2],f[2]);d.length;){var n=d.pop();c.push(n);if(0===k&&n.a[0]>m||2===k&&n.a[0]>h[2])break;n.left?(e.M(n),g=e.o(n),f=e.o(n),
