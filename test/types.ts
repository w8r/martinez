...
const poly1Coords = poly1.geometry.coordinates as Position[][];
const poly2Coords = poly2.geometry.coordinates as Position[][];
const multiPolyCoords = multiPoly.geometry.coordinates as Position[][][];
