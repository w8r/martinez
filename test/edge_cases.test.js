...
tap.test('Edge cases', (main) => {
  ...
  main.test('infinite loop crash', (t) => {
    ...
    const r = [[[
      [198.56943964860557, 22.943242898435663],
      [253.09375, 40.984375],
      [260.125, 59.265625],
      [280.6098710128091, 60.657800699899646],
      [280.6098710128091, 62.94324289843566],
      [198.56943964860557, 22.943242898435663]
    ]]];
  ...
  main.test('collapsed edges removed', (t) => {
    ...
    t.deepEqual(martinez.intersection(p1, p2), [[[[291,197],[330,230],[353,205],[384,237],[420,202],[355,139],[291,197]]]]);
    t.end();
  });
